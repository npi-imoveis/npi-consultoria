      ...
      <div className="relative flex-1">
        <div className="relative z-10 text-center lg:text-left">
          ...
          <p className="text-black font-medium text-base py-5">
            ...
            Somos um ecossistema colaborativo que reúne imobiliárias boutique especializadas em
            imóveis de alto padrão, oferecendo uma estratégia inovadora para a captação de clientes
            de high ticket altamente qualificados. Combinamos tecnologia, atendimento premium e uma
            seleção rigorosa de propriedades para oferecer uma experiência única na compra e venda
            de imóveis sofisticados para nossos clientes
          </p>
