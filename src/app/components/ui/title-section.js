...
export function TitleSection({ destaque, section, title, description, button, center }) {
  return (
    <div
      className={`container mx-auto flex flex-col p-4 ${center ? "items-center text-center" : ""
        }`}
    >
