        ...
        <div className="xl:w-[80%] sm:w-[85%] w-[90%] mx-auto flex flex-col md:flex-row lg:gap-4 gap-6 justify-center lg:items-stretch md:items-center mt-4">
          ...
          <div className="md:w-[50%] w-full dark:bg-gray-900 dark:text-gray-400 md:p-6 p-4 rounded-md">
            ...
            <p className="text-lg mt-4 leading-relaxed">
              {sobre?.descricao ||
                "O HUB de Imobiliárias Boutique de Alto Padrão é um novo e exclusivo modelo de negócios no mercado imobiliário, criado pela NPi Imóveis, especializada em SEO desde 2014, e hoje focada em dar visibilidade aos imóveis das imobiliárias pertencentes a esse ecossistema, através do posicionamento orgânico na maior vitrine do mundo: o Google. O HUB é uma rede que reúne imobiliárias especialistas em alto padrão, focadas em determinadas regiões, que se beneficiam de uma estratégia inovadora para divulgação dos seus imóveis e captação de clientes de high ticket qualificados, com uma alta redução de custos de marketing com portais e redes sociais."}
            </p>
          </div>
        </div>
