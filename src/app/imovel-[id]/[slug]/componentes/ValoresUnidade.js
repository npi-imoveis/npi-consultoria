        ...
        <div className="px-6 pt-6 bg-white rounded-lg">
            <div itemScope itemType="https://schema.org/Offer">
                ...
                {imovel.Status == "LOCAÇÃO" ? (
                    <h2 className="text-2xl font-bold mt-2" itemProp="price" content={imovel.ValorAluguelSite || "Consultar"}>
                        {imovel.ValorAluguelSite !== "0" ? "R$ " + imovel.ValorAluguelSite : "Consultar"}
                    </h2>
                ) : (
