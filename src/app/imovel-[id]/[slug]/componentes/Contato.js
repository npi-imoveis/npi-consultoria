    ...
    return (
        <div className="rounded-lg min-w-[350px] w-full bg-white shadow-2xl p-4 mt-4 lg:mt-[-50px]">
            ...
            <div className="px-6 pb-10">
                <h3 className="text-base font-bold text-black" id="contato-form">{imovel.ValorAntigo ? "Gostou deste imóvel?" : "Quero uma unidade nesse condomínio"}</h3>
                <p className="text-sm text-gray-600 mt-2">
                    {imovel.ValorAntigo ? "Fale conosco pelo WhatsApp ou preencha o formulário de contato." : "Mas não se preocupe, é possivel que outros imóveis estejam disponíveis no mesmo condomínio."}
                </p>
                    ...
                    <form onSubmit={handleSubmit} aria-labelledby="contato-form">
                        <div className="mt-8 space-y-3">
                            <div>
                                ...
                                />
                                {errors.nome && (
                                    <p className="text-red-500 text-xs mt-1" id="nome-error">Por favor, informe seu nome</p>
                                )}
                            </div>
                            ...
                            <div>
                                ...
                                <input
                                    ...
                                    className={`w-full border ${errors.telefone ? "border-red-500" : "border-gray-300"
                                        } rounded-lg py-2 px-3 text-zinc-700 text-xs font-semibold`}
                            ...
                            <div>
                                ...
                                />
                                {errors.email && (
                                    <p className="text-red-500 text-xs mt-1" id="email-error">Por favor, informe um e-mail válido</p>
                                )}
                            </div>
                        </div>
                ...
                {formState === "loading" && (
                    <div className="flex items-center justify-center mt-8 h-40" aria-live="polite" aria-busy="true">
                        <div className="animate-spin rounded-full h-12 w-12 border-t-2 border-b-2 border-black" role="status">
