...
export default async function AdminDashboard() {
  ...
  const imoveis = response.data.totalImoveis;
  const condominios = response.data.totalCondominios;
  const automacao = response.data.totalAutomacao;
  const corretores = response.data.totalCorretores;
