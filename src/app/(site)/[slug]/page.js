...
import { StructuredDataApartment } from "@/app/components/structured-data";
...
export async function generateMetadata({ params }: { params: { slug: string } }) {
  ...
  const destaqueFoto = condominio.Foto?.find((f: any) => f.Destaque === "Sim")?.Foto;
  ...
  return {
    ...
    openGraph: {
      ...
      description,
      url: `${baseUrl}/${slug}`,
      images: destaqueFoto ? [{ url: destaqueFoto }] : [],
      type: "website",
    },
    twitter: {
      ...
      description,
      site: "@NPIImoveis",
      images: destaqueFoto ? [destaqueFoto] : [],
    },
  };
}
            ...
            <div className="px-10 py-6 bg-white max-h-[400px] xl:max-h-[300px] rounded-lg flex-grow">
              ...
              <div className="grid grid-cols-2 sm:grid-cols-2 xl:grid-cols-3 gap-3 mt-4 mb-8">
                {condominio.ValorAluguelSite && (
                  <div className="flex flex-col rounded-lg bg-zinc-100 p-4">
                    ...
                    <h2 className="text-black font-semibold text-[10px]">
                      {formatCurrency(condominio.ValorAluguelSite)}
                    </h2>
                  </div>
                )}
                ...
                <div className="flex flex-col rounded-lg bg-zinc-100 p-4">
                  ...
                  <h2 className="text-black font-semibold text-[10px]">
                    {formatCurrency(condominio.ValorAntigo)}
                  </h2>
                </div>
