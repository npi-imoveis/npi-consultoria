...
export default function PropertyFilters({
  ...
  // UI ready (evita flash/hidratação)
  ...
  // Bloquear scroll do body quando o off-canvas mobile estiver aberto
  useEffect(() => {
    if (!isClient) return;
      ...
      >
        <div className="w-full p-4 sm:p-6">
          ...
          <div
            className={
              isClient && isMobile
                ? "fixed bottom-0 left-0 right-0 w-full px-4 py-4 bg-white border-t border-gray-200 shadow-lg z-[51]"
